...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  <strong>Error !</strong> Something went Wrong !</div>';
    ...
    public function google_oauth2_register($data)
    {
        $name = $data['name'];
        $username = $data['username'];
        $email = $data['email'];
...
// Check User Account Satatus
    public
    function CheckActiveUser($email)
    {
...
// User Login Authotication Method
    public
    function userLoginAuthotication($data)
    {
        $email = $data['email'];
        $password = $data['password'];
...
//   Get Single User Information By Id Method
    public
    function updateUserByIdInfo($userid, $data)
    {
        $name = $data['name'];
        $username = $data['username'];
        $email = $data['email'];
...
// User Deactivated By Admin
    public
    function userDeactiveByAdmin($deactive)
    {
        $sql = "UPDATE tbl_users SET
...
// User Deactivated By Admin
    public
    function userActiveByAdmin($active)
    {
        $sql = "UPDATE tbl_users SET
       isActive=:isActive
       WHERE id = :id";
...
// Check Old password method
    public
    function CheckOldPassword($userid, $old_pass)
    {
...
// Change User pass By Id
    public
    function changePasswordBysingelUserId($userid, $data)
    {
